...
def run_preprocessing():
    ...
    for patient in tqdm(patients):
        ...
        if patient.name not in patients_to_preprocesse:
            ...
            continue
        print("processing: ", patient.name)
        preprocessed_folder = [folder for folder in patient.dirs() if "z_score_n4_brainlesion_percentile" in folder.name][0]
...
def preprocess_exam_in_brats_style(inputDir: str, patID: str, outputDir: str) -> None:
    ...
    t1_file = inputDir / patID + "_z_score_n4_brainlesion_" + "T1w.nii.gz"
    t1c_file = inputDir / patID + "_z_score_n4_brainlesion_" + "T1c.nii.gz"
    t2_file = inputDir / patID + "_z_score_n4_brainlesion_" + "T2w.nii.gz"
    flair_file = inputDir / patID + "_z_score_n4_brainlesion_" + "FLAIR.nii.gz"
...
def normalize():
    ...
    for patient in tqdm(patients):
        ...
        for raw_file in raw_files:
            ...
            file_name = patient + "_z_score_n4_brainlesion_" + sequence_type + ".nii.gz"
