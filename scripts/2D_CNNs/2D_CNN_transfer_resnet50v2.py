...
# slice - clinical data - contrast weights:
path_to_weights = constants.path_to_logs / "transfer_resnet50v2_00_2_cls_no_clin_slice_rgb_normal_DA_upper_layer_run_2024_12_09_06_27_15/fold_0/saved_weights.weights.h5"
...
def build_transfer_resnet50_model(trainable = True):
    """
    ...
    resnet50_image_features = tf.keras.layers.Flatten()(x)

    # --- Feature Concatenation ---
    # use 'clinical_data' and 'use_layer'

    inputs_to_concat = [resnet50_image_features]
    ...
    if len(inputs_to_concat) > 1:
        ...
        concatenated_features = resnet50_image_features # No concatenation needed
