...
def build_transfer_efficientv2_model(trainable = True):
    ...
    x = hub.KerasLayer("https://www.kaggle.com/models/google/efficientnet-v2/TensorFlow2/imagenet21k-xl-feature-vector/1", trainable=trainable, dtype='float32')(x)
    ...
    inputs_to_concat = [efficient_image_features]
    ...
    if len(inputs_to_concat) > 1:
        ...
        concatenated_features = efficient_image_features # No concatenation needed
    ...
    if num_classes == 2:
        ...
        metrics = ["accuracy",
                   ...
                   tf.keras.metrics.F1Score(name = "f1_score", thresholds = 0.5)]
