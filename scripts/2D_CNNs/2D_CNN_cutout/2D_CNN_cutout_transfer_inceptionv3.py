...
path_to_weights = path_to_logs + "/transfer_inceptionv3_00_2_cls_cutout_rgb_upper_layer_run_2024_10_29_14_15_08/fold_0/saved_weights.weights.h5"
...
def build_transfer_inceptionv3_model():
    ...
    model = tf.keras.Model(inputs = [image_input, sex_input, age_input], outputs = [output], name = "transfer_inceptionv3_model")
