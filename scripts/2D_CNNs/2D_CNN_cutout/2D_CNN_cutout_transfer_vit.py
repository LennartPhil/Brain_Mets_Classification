...
def train_ai():
    ...
    if use_k_fold:
        ...
        for fold in range(10):
            ...
            # build model
            model = build_transfer_vit_model(clinical_data = clinical_data)
        ...
        model = build_transfer_vit_model(clinical_data = clinical_data, trainable = False)
...
def build_transfer_vit_model(clinical_data, trainable = True):
