...
training_codename = "transfer_vit_upperlayer_00"
...
path_to_weights = path_to_logs + "/transfer_inceptionv3_upperlayer00_4_classes_run_2024_08_11_05_54_12/fold_0/saved_weights.weights.h5"
...
def train_ai():
    ...
    print(f"Starting {training_codename} with {num_classes} classes at {time}")
    ...
    if use_k_fold:
        ...
        model = build_transfer_vit_model(trainable = False)
        ...
        # build model
        model = build_transfer_vit_model()
...
def build_transfer_vit_model(trainable = True):
    ...
    model = tf.keras.Model(inputs = [image_input, sex_input, age_input], outputs = [output], name = "transfer_vit_model")
...
data_augmentation = tf.keras.Sequential([
    ...
    NormalizeToRange(zero_to_one=False),
