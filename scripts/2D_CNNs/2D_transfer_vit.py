...
def build_transfer_vit_model(trainable = True):
    ...
    x = hub.KerasLayer("https://www.kaggle.com/models/spsayakpaul/vision-transformer/TensorFlow2/vit-b16-fe/1", trainable=trainable, dtype='float32')(x)
    ...
    inputs_to_concat = [vit_image_features]
